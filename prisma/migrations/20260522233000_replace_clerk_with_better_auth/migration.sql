-- Clear Clerk-linked demo rows before replacing clerkUserId with Better Auth userId
...
-- DropIndex
DROP INDEX "employees_clerkUserId_key";

-- AlterTable
ALTER TABLE "employees" DROP COLUMN "clerkUserId",
